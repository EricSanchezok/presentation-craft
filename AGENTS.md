...
A reusable skill, HTML stage runtime, and evidence-backed examples for audience-led presentations.
...
- Work within the user-authorized repository scope. Global skill installation and publishing are separate actions.
...
None. Local hooks and hosted automation are not enabled.
